...
//                " t.fswechatno=f.wechatno and t.jswechatno=f.fdwechatno  where f.friendqh is not null and t.aj_id="+id+seach;
        ...
        sql.append(" on t.fswechatno=f.wechatno and t.jswechatno=f.fdwechatno where f.friendqh is not null and t.aj_id="+id+") group by fswechatno,jswechatno)  t where 1=1 "+seach+" )");
