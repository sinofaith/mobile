                                ...
                                <form action="${pageContext.request.contextPath}/phoneqqFriend/seachCode" method="post">
                                    <div class="form-group_search  fl_l width100" >
                                        ...
                                        <select name="seachCondition" class="width100" STYLE="margin-bottom: 20px;">
                                            <option value="qq"<c:if test="${friendxxSeachCondition=='qq'}">selected="selected"</c:if>>QQ号</option>
                                            <option value="name" <c:if test="${friendxxSeachCondition=='name'}">selected="selected"</c:if>>姓名</option>
                                            <option value="fdqq" <c:if test="${friendxxSeachCondition=='fdqq'}">selected="selected"</c:if>>好友qq号</option>
                                            <option value="friendqqnc" <c:if test="${friendxxSeachCondition=='friendqqnc'}">selected="selected"</c:if>>好友昵称</option>
                                            <option value="qqfriendbz" <c:if test="${friendxxSeachCondition=='qqfriendbz'}">selected="selected"</c:if>>qq好友备注</option>
