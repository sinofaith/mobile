...
<div class="tab_div">
    <span class="tab_nav">  <a href="/word/title">线索信息</a><a href="/word/sfzhm">身份证号码比对结果</a><a href="/word/sjhm" class="addactive">手机号码比对结果</a></span>
    <ul >
                ...
                <div class="cantent_block ">
                                    ...
                                    <tr>
                                        <td colspan="10"  align="center" class="dropdown_index" style="background-color: #eee;">
                                            <div class="dropdown " style="color: #333">
                                                <strong>手机号比对信息</strong>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr align="center">
                                        <%--<td width="6%">序号</td>--%>
                                        <td width="7%">手机号码(统计次数)</td>
                                        <td width="12%">文档名</td>
                                        <td width="6%">导入时间</td>
                                    </tr>
                                    ...
                                    <c:forEach items="${detailinfo}" var="item" varStatus="st">
                                        <tr class="${st.index%2==1 ? '':'odd' }">
                                            <td align="center" class="hebing">
                                                    <button  data-toggle="modal" data-target="#myModal" style="color: black"  onclick="getSfDetails(this,'sjhm')">
                                                            ${fn:substring(item.sfzhm,0,11)}<span style="color: red">${fn:substring(item.sfzhm,11 ,fn:length(item.sfzhm) )}</span>
                                                    </button>
                                            </td>
                                            <td align="center">
                                                <c:choose>
                            ...
                            <c:choose>
                                <c:when test="${detailinfo!=null && detailinfo.size()!=0}">
                                    <div  class="page_nmber">
                                        ...
                                        <a href="/word/sjhm/seach?pageNo=${page.topPageNo }"><input type="button" name="fristPage" value="首页" /></a>
                                        <c:choose>
                                            <c:when test="${page.pageNo!=1}">
                                                <a href="/word/sjhm/seach?pageNo=${page.previousPageNo }"><input type="button" name="previousPage" value="上一页" /></a>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${page.pageNo != page.totalPages}">
                                                <a href="/word/sjhm/seach?pageNo=${page.nextPageNo }"><input type="button" name="nextPage" value="下一页" /></a>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="button" disabled="disabled" name="nextPage" value="下一页" />
                                            </c:otherwise>
                                        </c:choose>
                                        <a href="/word/sjhm/seach?pageNo=${page.bottomPageNo }"><input type="button" name="lastPage" value="尾页" /></a>
                                        <input type="number" id="num" max="${page.totalPages}" style="width: 9%" min="1">
                                        <input type="button" value="跳转" onclick="wordSkip('sjhm')">
                    ...
                    <div class="sidebar_right pos_re">
                        ...
                        <div class=" ">
                            ...
                            <div>
                                <form action="/word/sjhm/SeachCode" method="post">
                                    <div class="form-group_search  fl_l width100" >
                                        <span style="margin-left: 10px;color: #444;padding-bottom: 10px;">查询方式</span>
                                        <select name="seachCondition" class="width100" STYLE="margin-bottom: 20px;">
                                            <option value="sjhm" <c:if test="${sjseachCondition=='sjhm'}">selected="selected"</c:if> >手机号码</option>
                                            <option value="title" <c:if test="${sjseachCondition=='title'}">selected="selected"</c:if> >文档名</option>
                                        ...
                                        <textarea  class="form-control02 seachCode fl_l width100" id="seachCode" placeholder="请输入要查询内容" name="seachCode" >${sjseachCode}</textarea>
                                    </div>
                       ...
                       <span class="fl_l width100 " style="padding-bottom: 10px;margin-top: 10px;">
                           ...
                           <button  type="button"  class="sideBar_r_button"  onclick="location.href='/word/sjhm/download'" >数据导出</button>
                       </span>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" style="top: 0%; min-width: 80%;left: 10%;right: 10%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">手机号-文档名<span id="title"></span></h4>
            </div>
