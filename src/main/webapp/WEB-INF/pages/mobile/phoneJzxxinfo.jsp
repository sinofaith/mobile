                                    ...
                                    <tr>
                                        <td colspan="13"  align="center" class="dropdown_index" style="background-color: #eee;">
                                            <div class="dropdown " style="color: #333">
                                                <strong>机主信息(${aj.caseName})</strong>
                            ...
                            <div>
                                <form action="${pageContext.request.contextPath}/phone/seachCode" method="post">
                                    <div class="form-group_search  fl_l width100" >
                                        ...
                                        <textarea  class="form-control02 seachCode fl_l width100" id="seachCode" placeholder="请输入要查询内容,加%模糊查询 例如:%xxx%" name="seachCode" >${phoneJzxxSeachCode}</textarea>
                                    </div>
