...
<div class="tab_div">
    <span class="tab_nav"><a href="/word/user" class="addactive">用户列表</a></span>
    <ul >
        <div class="main-container-inner " style="margin-bottom: 10px">
            <div class="width_100 pos_re_block">
                <div class="cantent_block ">
                            ...
                            <c:choose>
                                <c:when test="${detailinfo!=null && detailinfo.size()!=0}">
                                    <div  class="page_nmber">
                                        ...
                                        <a href="/word/user/seach?pageNo=${page.topPageNo }"><input type="button" name="fristPage" value="首页" /></a>
                                        <c:choose>
                                            <c:when test="${page.pageNo!=1}">
                                                <a href="/word/user/seach?pageNo=${page.previousPageNo }"><input type="button" name="previousPage" value="上一页" /></a>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${page.pageNo != page.totalPages}">
                                                <a href="/word/user/seach?pageNo=${page.nextPageNo }"><input type="button" name="nextPage" value="下一页" /></a>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="button" disabled="disabled" name="nextPage" value="下一页" />
                                            </c:otherwise>
                                        </c:choose>
                                        <a href="/word/user/seach?pageNo=${page.bottomPageNo }"><input type="button" name="lastPage" value="尾页" /></a>
                                        <input type="number" id="num" max="${page.totalPages}" style="width: 9%" min="1">
                                        <input type="button" value="跳转" onclick="wordSkip('user')">
                    ...
                    <div class="sidebar_right pos_re">
                        ...
                        <div class=" ">
                            ...
                            <div>
                                <form action="/word/user/SeachCode" method="post">
                                    <div class="form-group_search  fl_l width100" >
                                        <span style="margin-left: 10px;color: #444;padding-bottom: 10px;">查询方式</span>
                                        <select name="seachCondition" class="width100" STYLE="margin-bottom: 20px;">
                                            <option value="username"<c:if test="${useachCondition=='title'}">selected="selected"</c:if>>用户名</option>
                                        ...
                                        <textarea  class="form-control02 seachCode fl_l width100" id="seachCode" placeholder="请输入要查询内容" name="seachCode" >${useachCode}</textarea>
                                    </div>
                            ...
                            <div class="width100" style="margin-top: 10px;float: left;">
                                <span style="margin-left: 10px;color: #444;padding-bottom: 10px;margin-top: 20px;">新建用户</span>
                ...
                <button class="sideBar_r_button" data-toggle="modal"
                        data-target="#myModal">新建用户</button>
            ...
            <div class="modal-body">
                ...
                <div class="file-box">
                    ...
                    用&nbsp;&nbsp;户&nbsp;&nbsp;名:<input type="text" name = 'username' id ='username'
                               class='txt username '  data-toggle="tooltip" data-placement="top" oninput="destroyTooltip()" ><br>
                    密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 码:<input type="password" name = 'password' id ='password'
                               class='txt password'  data-toggle="tooltip" data-placement="top" oninput="destroyTooltip()" ><br>
                    重复密码:<input type="password" name = 'repassword' id ='repassword'
                                           class='txt repassword'  data-toggle="tooltip" data-placement="top" oninput="destroyTooltip()" ><br>
                    用户类别:
