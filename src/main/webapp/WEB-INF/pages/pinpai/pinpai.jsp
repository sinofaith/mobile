...
<div class="tab_div">
    <span class="tab_nav"><a href="/mobile" class="addactive">品牌</a><a href="/mobile/aj">案件</a></span>
    <ul >
                                ...
                                <form action="/word/title/SeachCode" method="post">
                                    <div class="form-group_search  fl_l width100" >
                                        ...
                                        <select name="seachCondition" class="width100" STYLE="margin-bottom: 20px;">
                                            <option value="title"<c:if test="${wseachCondition=='pinpaim'}">selected="selected"</c:if>>品牌名</option>
                                        ...
                                        <textarea  class="form-control02 seachCode fl_l width100" id="seachCode" placeholder="请输入要查询内容" name="seachCode" >${wseachCode}</textarea>
                                    </div>
